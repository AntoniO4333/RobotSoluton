...
namespace RobotLibrary2
{
    ...
    public class Robot
    {
        ...
        private string ToString(int RobotNumber)
        {
            return ($"Робот {RobotNumber} {DirName(dir)} ({coord.Item1} , {coord.Item2})");
        }
        ...
        /// </summary>
        public void Move(int RobotNumber)
        {
            RandomizeDirection();
            switch (dir)
            {
            ...
            Console.WriteLine(ToString(RobotNumber));
        }
    }
}
